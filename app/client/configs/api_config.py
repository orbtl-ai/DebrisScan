...
class BaseConfig:
    ...
    0.0 to 1.0 (0% to 100% confidence). All predicted objects below this threshold will
    be dropped from the outputs. Turn this up for a more conservative set of predictions
    (i.e., lower false positive rate, higher false negative rate).
    """
